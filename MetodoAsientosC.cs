...
{
    //class MetodoAsientosC
    //{
    //    protected static readonly ArrayList Campos = new ArrayList(50);

    //    //Rellena el arraylist de la casilla 0 hasta la 49, generando 50 espacios los cuales 
    //    //serán usados como indice para introducir los datos de los pasajeros y que estos no
    //    //sean introducidos de manera desordenada pues los arraylist son listas dinamicas que
    //    //incrementan su tamaño dependiendo de la cantidad de objetos que se le inserten.
    //    //Para introducirle los objetos, en lugar de meterle crear un nuevo espacio, solo se 
    //    //reemplaza la casilla con index (X) y un null en su interior con un objeto.
    ...
    //                    MessageBox.Show($"{pasajero.Nombre} ha sido asignado/a al asiento numero {pasajero.Asiento} de la tercera clase",
    ...
    //                            {
    //                                Campos[i] = null;
    //                                //MessageBox.Show($"La reserva del asiento numero {asiento} fue cancelada");
