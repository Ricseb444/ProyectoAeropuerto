...
namespace BLL
{
    public class MetodoAsientosA
    {
        ...
        {
            List<Pasajero> ListaPasajeros = PDAL.GetAll("pasajeros");
        ...
        public int AgregarPasagero(int numA, Pasajero pasajero)
        {
            ...
            if (asientosLibres > 0)
            {
                ...
                {
                    if (PDAL.GetByid(pasajero.Cedula, "pasajeros") == null)
                    {
                ...
                stringBuilder.Clear();
                PDAL.Insert(pasajero, "pasajeros");
                ...
                if (item is Pasajero pasajero)
                {
                    if (string.Equals(pasajero.Clase, clase, StringComparison.OrdinalIgnoreCase))
                    {
                        if (int.Equals(pasajero.Asiento, asiento))
                        {
                            ...
                            {
                                PDAL.Delete(pasajero.Cedula, "pasajeros");
